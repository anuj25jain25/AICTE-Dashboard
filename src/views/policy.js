    ...
    render() {
        return (
            <div className="terms-wrap">
                <article>
                    <h3 className="ft-geor ft-bold">Policy</h3>
                    <div className="italic_text">Privacy Policy</div>
                    ...
                    <div className="italic_text">Site Visit Data:</div>
            ...
            We will not identify users or their browsing activities, except when a law enforcement agency may exercise a warrant to inspect the service provider's logs.</p>
                </article>
                <article>
                    <h3 className="ft-geor ft-bold">Cookies</h3>
                    ...
                    <div className="italic_text">Email Management:</div>
                    ...
                    <div className="italic_text">Collection of Personal Information:</div>
                    ...
                    <div className="italic_text">Note:</div>
                ...
                <article>
                    <h3 className="ft-geor ft-bold">Copyright Policy</h3>
                    <p>The contents of this website may not be reproduced partially or fully, without due permission from All India Council for Technical Education, Govt. of India. If referred to as a part of another publication, the source must be appropriately acknowledged. The contents of this website can not be used in any misleading or objectionable context.</p>
                </article>
                <article>
                    <h3 className="ft-geor ft-bold">Hyperlink Policy</h3>
                    <div className="italic_text">Links To External Websites/Portals</div>
                    ...
                    <div className="italic_text">Links To All India Council for Technical Education Website By Other Websites/Portals</div>
